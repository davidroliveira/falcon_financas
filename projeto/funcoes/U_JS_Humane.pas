...
type
  ...
  public
    ...
    class procedure success(str: string; milliseconds: integer; clickToClose :Boolean);
...
//=========================================================================
class procedure humane.success(str: string; milliseconds: integer; clickToClose :Boolean);
begin
  UniSession.AddJS('humane.timeout=' + IntToStr(milliseconds) + ';');

  UniSession.AddJS('humane.clickToClose=' + BoolToStr(clickToClose) + ';');
